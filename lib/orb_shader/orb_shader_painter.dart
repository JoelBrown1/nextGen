...
class OrbShaderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    double fov = v64.mix(pi / 4.3, pi / 2, config.zoom.clamp(0, 1));

    v64.Vector3 colorToVector3(Color c) => v64.Vector3(
          c.red.toDouble(),
          c.green.toDouble(),
          c.blue.toDouble(),
        );
    ...
    shader.setFloat(5, config.roughness.clamp(0, 1));
    shader.setFloat(6, config.metalness.clamp(0, 1));
    ...
    shader.setFloat(17, config.ior.clamp(0, 2));
    shader.setFloat(18, config.lightAttenuation.clamp(0, 1));
    shader.setFloat(19, ambientLight.x);
    shader.setFloat(20, ambientLight.y);
    shader.setFloat(21, ambientLight.z);
    shader.setFloat(22, config.ambientLightDepthFactor.clamp(0, 1));
